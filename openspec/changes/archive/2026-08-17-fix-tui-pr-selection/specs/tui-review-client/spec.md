...
The system SHALL provide a full-screen interactive interface listing actionable pull requests ranked by relevance score with keyboard and mouse navigation.
...
- **WHEN** a pull request is selected or clicked in the queue or when the active queue tab is switched
